...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="player-form" class="form-validate form-horizontal">
	...
	<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'player')); ?>
	<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'player', JText::_('COM_BOXLEAGUE_TAB_PLAYER', true)); ?>
	<div class="row-fluid">
		<div class="span10 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo JText::_('COM_BOXLEAGUE_FIELDSET_PLAYER'); ?></legend>
