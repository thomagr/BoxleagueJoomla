 ...
 * @since  1.6
 */
class BoxleagueViewMatch extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(Text::_('COM_BOXLEAGUE_TITLE_MATCH'), 'match.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_boxleague.match', $this->item->id);
		}
