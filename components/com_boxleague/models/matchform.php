 ...
 * @since  1.6
 */
class BoxleagueModelMatchForm extends \Joomla\CMS\MVC\Model\FormModel
{
    private $item = null;
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_boxleague.match', 'matchform', array(
                        'control'   => 'jform',
                        'load_data' => $loadData
                )
        );
    ...
    {
        $id    = (!empty($data['id'])) ? $data['id'] : (int) $this->getState('match.id');
