 ...
 * @since  1.6
 */
class BoxleagueModelBoxes extends \Joomla\CMS\MVC\Model\ListModel
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
            ...
            $query->from('`#__boxleague_box` AS a');
	...
	public function getItems()
	{
		...
		foreach ($items as $item)
		{
			...
			if (isset($item->boxleague_id))
			{

				$values    = explode(',', $item->boxleague_id);
				$textValue = array();
				...
				$item->boxleague_id = !empty($textValue) ? implode(', ', $textValue) : $item->boxleague_id;
			}
