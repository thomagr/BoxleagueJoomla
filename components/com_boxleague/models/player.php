 ...
 * @since  1.6
 */
class BoxleagueModelPlayer extends \Joomla\CMS\MVC\Model\ItemModel
{
    public $_item;
	...
	public function getItem($id = null)
	{
		...
		if (isset($this->_item->box_id) && $this->_item->box_id != '')
		{
			...
			foreach ($values as $value)
			{
				...
				$query
					->select('CONCAT(`#__boxleague_box_3455540`.`boxleague_id`, \' - \', `#__boxleague_box_3455540`.`bx_name`) AS `fk_value`')
	...
	public function getItemIdByAlias($alias)
	{
            ...
            {
            	$aliasKey   = $this->getAliasFieldNameByView('player');
            }
