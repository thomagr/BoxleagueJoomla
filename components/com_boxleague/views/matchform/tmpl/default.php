...
<div class="match-edit front-end-edit">
	...
	<?php foreach((array)$this->item->home_player as $value): ?>
		<?php if(!is_array($value)): ?>
			<input type="hidden" class="home_player" name="jform[home_playerhidden][<?php echo $value; ?>]" value="<?php echo $value; ?>" />
		<?php endif; ?>
	<?php endforeach; ?>
	...
	<?php foreach((array)$this->item->away_player as $value): ?>
		<?php if(!is_array($value)): ?>
			<input type="hidden" class="away_player" name="jform[away_playerhidden][<?php echo $value; ?>]" value="<?php echo $value; ?>" />
		<?php endif; ?>
	<?php endforeach; ?>
