...
<div class="player-edit front-end-edit">
	<?php if (!$canEdit) : ?>
		<h3>
	...
	<?php else : ?>
		...
		<form id="form-player"
			  action="<?php echo Route::_('index.php?option=com_boxleague&task=player.save'); ?>"
	...
	<?php foreach((array)$this->item->box_id as $value): ?>
		<?php if(!is_array($value)): ?>
			<input type="hidden" class="box_id" name="jform[box_idhidden][<?php echo $value; ?>]" value="<?php echo $value; ?>" />
		<?php endif; ?>
	<?php endforeach; ?>
	...
	<?php endforeach; ?>
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo Route::_('index.php?option=com_boxleague&task=playerform.cancel'); ?>"
